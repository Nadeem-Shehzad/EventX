...
exports.EventQueueModule = EventQueueModule = __decorate([
    (0, common_1.Module)({
        imports: isTest ? [] :
            [
                bullmq_1.BullModule.registerQueue({ name: queue_constants_1.QUEUES.TICKET_QUEUE }, { name: queue_constants_1.QUEUES.BOOKING_QUEUE }, { name: queue_constants_1.QUEUES.PAYMENT_QUEUE })
            ],
