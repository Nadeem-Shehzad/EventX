...
let OutboxDispatcher = OutboxDispatcher_1 = class OutboxDispatcher {
    constructor(outboxService, ticketQueue, bookingQueue, paymentQueue) {
    ...
    async processEvent(event) {
        ...
        if (eventType === domain_events_1.DOMAIN_EVENTS.BOOKING_CREATED ||
            eventType === domain_events_1.DOMAIN_EVENTS.TICKET_SOLD) {
            await this.ticketQueue.add(eventType, payload, this.jobOptions(_id.toString()));
        }
        else if (eventType === domain_events_1.DOMAIN_EVENTS.BOOKING_CONFIRM_REQUESTED ||
            eventType === domain_events_1.DOMAIN_EVENTS.BOOKING_CONFIRMED ||
            eventType === domain_events_1.DOMAIN_EVENTS.BOOKING_PAYMENT_FAILED ||
            eventType === domain_events_1.DOMAIN_EVENTS.BOOKING_PAYMENT_REFUNDED) {
            await this.bookingQueue.add(eventType, payload, this.jobOptions(_id.toString()));
        }
        else if (eventType === domain_events_1.DOMAIN_EVENTS.PAYMENT_REQUEST ||
            eventType === domain_events_1.DOMAIN_EVENTS.PAYMENT_FAILED ||
            eventType === domain_events_1.DOMAIN_EVENTS.PAYMENT_REFUND_REQUEST) {
...
exports.OutboxDispatcher = OutboxDispatcher = OutboxDispatcher_1 = __decorate([
    ...
    __param(1, (0, bullmq_1.InjectQueue)(queue_constants_1.QUEUES.TICKET_QUEUE)),
    __param(2, (0, bullmq_1.InjectQueue)(queue_constants_1.QUEUES.BOOKING_QUEUE)),
    __param(3, (0, bullmq_1.InjectQueue)(queue_constants_1.QUEUES.PAYMENT_QUEUE)),
