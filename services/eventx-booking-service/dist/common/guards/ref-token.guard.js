...
let JwtRefreshTokenGuard = class JwtRefreshTokenGuard {
    ...
    async canActivate(context) {
        ...
        if (!token) {
            throw new common_1.UnauthorizedException('Ref-Token is missing!');
        }
        try {
            ...
            throw new common_1.UnauthorizedException('Ref-Token is missing or expired!');
        }
    }
};
...
//# sourceMappingURL=ref-token.guard.js.map