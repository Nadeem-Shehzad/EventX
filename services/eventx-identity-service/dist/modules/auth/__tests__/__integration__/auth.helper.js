...
exports.forgotPasswordTestUser = exports.loginTestUser = exports.registerTestUser = void 0;
...
const registerTestUser = async (app, overrideData) => {
    ...
    const res = await (0, supertest_1.default)(app.getHttpServer())
        ...
        .expect(201);
    return { ...userData, _id: res.body._id };
};
...
const forgotPasswordTestUser = async (app, overrideData) => {
    const defaultData = {
        email: 'user@test.com'
    };
    const userData = { ...defaultData, ...overrideData };
...
exports.forgotPasswordTestUser = forgotPasswordTestUser;
